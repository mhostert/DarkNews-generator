...
def upscattering_dxsec_dQ2(x_phase_space, process, diagrams=['total']):
    ...
    k1vec = np.sqrt(s)/2*np.sqrt(lam(1, 0.0, M**2/s))
    k3vec =  np.sqrt(s)/2*np.sqrt(lam(1, mHNL**2/s, M**2/s))
    ...
    if process.TheoryModel.HNLtype == 'majorana':
        ...
        # SM NC SQR
        def Lmunu_Hmunu_NC_SQR():
            return -((Chad*Chad*Cij*Cji*(-8*((FFNCf1 - FFNCga)*(FFNCf1 - FFNCga)*k1k4*k2k3 + (FFNCf1 + FFNCga)*(FFNCf1 + FFNCga)*k1k2*k3k4)*(M*M) + 8*(FFNCf1 - FFNCga)*(FFNCf1 + FFNCga)*k1k3*(M*M*M*M) + 8*h*(M*M)*(FFNCga*(-2*FFNCf1*k1k4*k2s + FFNCgp*k1s*(k2k3 - k3k4) + 2*FFNCf1*k1k2*k4s + FFNCgp*k1k3*(-k2s + k4s)) + FFNCf1*FFNCf1*(k1k4*k2s + k1k2*k4s - k1s*(M*M)) + FFNCga*FFNCga*(k1k4*k2s + k1k2*k4s + k1s*(M*M)))*mHNL + 4*FFNCgp*(2*FFNCga*(k1k2 - k1k4)*(M*M) + FFNCgp*k1k3*(-k2k4 + M*M))*(mHNL*mHNL) + 4*(FFNCgp*FFNCgp)*h*k1s*(-k2k4 + M*M)*(mHNL*mHNL*mHNL) + FFNCf2*FFNCf2*(-4*k1k3*(k1k2*k1k4 + k2k3*k3k4 + k1k3*(M*M)) + 2*h*(-(k1k4*k1s*k2k3) + k1k3*k1k4*k2s + k1k3*k2s*k3k4 + k1k3*k2k3*k4s + k1k2*(2*k1k4*k1s - k1s*k3k4 + k1k3*k4s) + 2*k1k3*k1s*(M*M))*mHNL + (4*k1k2*k1k4 + k1k3*(k2k4 + 3*(M*M)))*(mHNL*mHNL) - h*(-(k1s*k2k4) + 2*k1k4*k2s + 2*k1k2*k4s + k1s*(M*M))*(mHNL*mHNL*mHNL)) + 4*FFNCf2*(FFNCf1*(M*M)*(2*k1k3*(-k1k2 + k1k4 + k2k3 - k3k4) + h*(k1s*(2*k1k2 - 2*k1k4 - k2k3 + k3k4) + k1k3*(-k2s + k4s))*mHNL + (k1k2 - k1k4)*(mHNL*mHNL)) + 2*FFNCga*(M*M)*(-(k1k3*(k1k2 + k1k4 + k2k3 + k3k4)) + h*((k1k2 + k1k4)*k1s + k1k3*(k2s + k4s))*mHNL + (k1k2 + k1k4)*(mHNL*mHNL)) + FFNCgp*h*mHNL*(k1k4*k1s*k2k3 - k1k3*k1k4*k2s - k1k2*k1s*k3k4 - k1k3*k2s*k3k4 + k1k2*k1k3*k4s + k1k3*k2k3*k4s + (k1k4*k2s - k1k2*k4s)*(mHNL*mHNL)))))/(M*M*((MZBOSON*MZBOSON - t)*(MZBOSON*MZBOSON - t))))
        # kinetic mixing term SQR
        def Lmunu_Hmunu_KinMix_SQR():
            # return ((-(FFf2*FFf2*(s*Sqrt((M*M*M*M + (mHNL*mHNL - s)*(mHNL*mHNL - s) - 2*(M*M)*(mHNL*mHNL + s))/(s*s))*(4*(M*M)*(mHNL*mHNL*mHNL*mHNL) + (2*(M*M) + mHNL*mHNL - 2*s)*(2*(M*M) + mHNL*mHNL - 2*s)*t - (8*(M*M) + mHNL*mHNL - 4*s)*(t*t)) + h*(4*(M*M)*(mHNL*mHNL*mHNL*mHNL)*(M*M + mHNL*mHNL - s) + (2*(M*M) - 4*M*mHNL + mHNL*mHNL - 2*s)*(2*(M*M) + 4*M*mHNL + mHNL*mHNL - 2*s)*(M*M + mHNL*mHNL - s)*t - (8*(M*M*M*M) + mHNL*mHNL*mHNL*mHNL - 3*(mHNL*mHNL)*s + 4*(s*s) - 3*(M*M)*(3*(mHNL*mHNL) + 4*s))*(t*t)))) - 8*FFf1*FFf2*(M*M)*(s*Sqrt((M*M*M*M + (mHNL*mHNL - s)*(mHNL*mHNL - s) - 2*(M*M)*(mHNL*mHNL + s))/(s*s))*(mHNL*mHNL*mHNL*mHNL + mHNL*mHNL*t - 2*(t*t)) + h*(mHNL*mHNL - 2*t)*(mHNL*mHNL*mHNL*mHNL - s*t + M*M*(mHNL*mHNL + t) - mHNL*mHNL*(s + t))) + 8*(FFf1*FFf1)*(M*M)*(s*Sqrt((M*M*M*M + (mHNL*mHNL - s)*(mHNL*mHNL - s) - 2*(M*M)*(mHNL*mHNL + s))/(s*s))*(2*(M*M*M*M) - 4*(M*M)*s + 2*(s*s) + 2*s*t + t*t - mHNL*mHNL*(2*s + t)) + h*(2*(M*M*M*M*M*M) - 2*((mHNL*mHNL - s)*(mHNL*mHNL - s))*s - 2*(M*M*M*M)*(mHNL*mHNL + 3*s) + (mHNL*mHNL*mHNL*mHNL + mHNL*mHNL*s - 2*(s*s))*t - (mHNL*mHNL + s)*(t*t) + M*M*(6*(s*s) + 2*s*t + t*t + mHNL*mHNL*(-2*s + t)))))*(Vhad*Vhad)*Vij*Vji)/(4.*(M*M)*s*Sqrt((M*M*M*M + (mHNL*mHNL - s)*(mHNL*mHNL - s) - 2*(M*M)*(mHNL*mHNL + s))/(s*s))*((mzprime*mzprime - t)*(mzprime*mzprime - t)))
            # return ((-8*FFf1*FFf2*(M*M)*(mHNL*mHNL*mHNL*mHNL + mHNL*mHNL*t - 2*(t*t)) + 8*(FFf1*FFf1)*(M*M)*(2*(M*M*M*M) - 4*(M*M)*s + 2*(s*s) + 2*s*t + t*t - mHNL*mHNL*(2*s + t)) - FFf2*FFf2*(4*(M*M*M*M)*t + 4*(M*M)*(mHNL*mHNL*mHNL*mHNL + mHNL*mHNL*t - 2*t*(s + t)) + t*(mHNL*mHNL*mHNL*mHNL + 4*s*(s + t) - mHNL*mHNL*(4*s + t))))*(Vhad*Vhad)*Vij*Vji)/(2.*(M*M)*((mzprime*mzprime - t)*(mzprime*mzprime - t)))
            return -(((8*(FFf1*FFf1)*(M*M)*(-(k1k4*k2k3) - k1k2*k3k4 + k1k3*(M*M) + h*(k1k4*k2s + k1k2*k4s - k1s*(M*M))*mHNL) + 4*FFf1*FFf2*(M*M)*(2*k1k3*(-k1k2 + k1k4 + k2k3 - k3k4) + h*(k1s*(2*k1k2 - 2*k1k4 - k2k3 + k3k4) + k1k3*(-k2s + k4s))*mHNL + (k1k2 - k1k4)*(mHNL*mHNL)) + FFf2*FFf2*(-4*k1k3*(k1k2*k1k4 + k2k3*k3k4 + k1k3*(M*M)) + 2*h*(-(k1k4*k1s*k2k3) + k1k3*k1k4*k2s + k1k3*k2s*k3k4 + k1k3*k2k3*k4s + k1k2*(2*k1k4*k1s - k1s*k3k4 + k1k3*k4s) + 2*k1k3*k1s*(M*M))*mHNL + (4*k1k2*k1k4 + k1k3*(k2k4 + 3*(M*M)))*(mHNL*mHNL) - h*(-(k1s*k2k4) + 2*k1k4*k2s + 2*k1k2*k4s + k1s*(M*M))*(mHNL*mHNL*mHNL)))*(Vhad*Vhad)*Vij*Vji)/(M*M*((mzprime*mzprime - t)*(mzprime*mzprime - t))))
        # kinetic mixing + SM NC interference
        def Lmunu_Hmunu_KinMix_NC_inter():
            return (-2*Chad*Cij*(2*FFf1*(M*M)*(2*FFNCf2*k1k3*(k1k2 - k1k4 - k2k3 + k3k4) + 4*(FFNCf1*k1k4*k2k3 - FFNCga*k1k4*k2k3 + FFNCf1*k1k2*k3k4 + FFNCga*k1k2*k3k4 - FFNCf1*k1k3*(M*M)) + h*(4*FFNCga*k1k4*k2s + FFNCf2*k1s*(-2*k1k2 + 2*k1k4 + k2k3 - k3k4) + FFNCf2*k1k3*(k2s - k4s) - 4*FFNCga*k1k2*k4s - 4*FFNCf1*(k1k4*k2s + k1k2*k4s - k1s*(M*M)))*mHNL + FFNCf2*(-k1k2 + k1k4)*(mHNL*mHNL)) + FFf2*(4*k1k3*(FFNCf2*(k1k2*k1k4 + k2k3*k3k4) + (FFNCf2*k1k3 + FFNCf1*(k1k2 - k1k4 - k2k3 + k3k4) + FFNCga*(k1k2 + k1k4 + k2k3 + k3k4))*(M*M)) - 2*h*(FFNCgp*(k1k4*(k1s*k2k3 - k1k3*k2s) - (k1k2*k1s + k1k3*k2s)*k3k4 + k1k3*(k1k2 + k2k3)*k4s) + (2*FFNCga*(k1k2 + k1k4)*k1s + FFNCf1*k1s*(2*k1k2 - 2*k1k4 - k2k3 + k3k4) + FFNCf1*k1k3*(-k2s + k4s) + 2*FFNCga*k1k3*(k2s + k4s))*(M*M) + FFNCf2*(-(k1k4*k1s*k2k3) + k1k3*k1k4*k2s + k1k3*k2s*k3k4 + k1k3*k2k3*k4s + k1k2*(2*k1k4*k1s - k1s*k3k4 + k1k3*k4s) + 2*k1k3*k1s*(M*M)))*mHNL - (FFNCf2*(4*k1k2*k1k4 + k1k3*k2k4) + (3*FFNCf2*k1k3 + 2*FFNCf1*(k1k2 - k1k4) + 4*FFNCga*(k1k2 + k1k4))*(M*M))*(mHNL*mHNL) + h*(-2*FFNCgp*k1k4*k2s + 2*FFNCgp*k1k2*k4s + FFNCf2*(-(k1s*k2k4) + 2*k1k4*k2s + 2*k1k2*k4s + k1s*(M*M)))*(mHNL*mHNL*mHNL)))*Vhad*Vij)/(M*M*(MZBOSON*MZBOSON - t)*(-(mzprime*mzprime) + t))
        # mass mixing + SM NC interference
        def Lmunu_Hmunu_MassMix_NC_inter():
            return (-2*Cij*Sqrt(Chad*Cprimehad)*(2*FFf1*(M*M)*(2*FFNCf2*k1k3*(k1k2 - k1k4 - k2k3 + k3k4) + 4*(FFNCf1*k1k4*k2k3 - FFNCga*k1k4*k2k3 + FFNCf1*k1k2*k3k4 + FFNCga*k1k2*k3k4 - FFNCf1*k1k3*(M*M)) + h*(4*FFNCga*k1k4*k2s + FFNCf2*k1s*(-2*k1k2 + 2*k1k4 + k2k3 - k3k4) + FFNCf2*k1k3*(k2s - k4s) - 4*FFNCga*k1k2*k4s - 4*FFNCf1*(k1k4*k2s + k1k2*k4s - k1s*(M*M)))*mHNL + FFNCf2*(-k1k2 + k1k4)*(mHNL*mHNL)) + FFf2*(4*k1k3*(FFNCf2*(k1k2*k1k4 + k2k3*k3k4) + (FFNCf2*k1k3 + FFNCf1*(k1k2 - k1k4 - k2k3 + k3k4) + FFNCga*(k1k2 + k1k4 + k2k3 + k3k4))*(M*M)) - 2*h*(FFNCgp*(k1k4*(k1s*k2k3 - k1k3*k2s) - (k1k2*k1s + k1k3*k2s)*k3k4 + k1k3*(k1k2 + k2k3)*k4s) + (2*FFNCga*(k1k2 + k1k4)*k1s + FFNCf1*k1s*(2*k1k2 - 2*k1k4 - k2k3 + k3k4) + FFNCf1*k1k3*(-k2s + k4s) + 2*FFNCga*k1k3*(k2s + k4s))*(M*M) + FFNCf2*(-(k1k4*k1s*k2k3) + k1k3*k1k4*k2s + k1k3*k2s*k3k4 + k1k3*k2k3*k4s + k1k2*(2*k1k4*k1s - k1s*k3k4 + k1k3*k4s) + 2*k1k3*k1s*(M*M)))*mHNL - (FFNCf2*(4*k1k2*k1k4 + k1k3*k2k4) + (3*FFNCf2*k1k3 + 2*FFNCf1*(k1k2 - k1k4) + 4*FFNCga*(k1k2 + k1k4))*(M*M))*(mHNL*mHNL) + h*(-2*FFNCgp*k1k4*k2s + 2*FFNCgp*k1k2*k4s + FFNCf2*(-(k1s*k2k4) + 2*k1k4*k2s + 2*k1k2*k4s + k1s*(M*M)))*(mHNL*mHNL*mHNL)))*Vhad*Vij)/(M*M*(MZBOSON*MZBOSON - t)*(-(mzprime*mzprime) + t))
        # kinetic mixing + mass mixing interference
        def Lmunu_Hmunu_KinMix_MassMix_inter():
            return (2*Cij*Cprimehad*(2*FFf1*(M*M)*(2*FFNCf2*k1k3*(k1k2 - k1k4 - k2k3 + k3k4) + 4*(FFNCf1*k1k4*k2k3 - FFNCga*k1k4*k2k3 + FFNCf1*k1k2*k3k4 + FFNCga*k1k2*k3k4 - FFNCf1*k1k3*(M*M)) + h*(4*FFNCga*k1k4*k2s + FFNCf2*k1s*(-2*k1k2 + 2*k1k4 + k2k3 - k3k4) + FFNCf2*k1k3*(k2s - k4s) - 4*FFNCga*k1k2*k4s - 4*FFNCf1*(k1k4*k2s + k1k2*k4s - k1s*(M*M)))*mHNL + FFNCf2*(-k1k2 + k1k4)*(mHNL*mHNL)) + FFf2*(4*k1k3*(FFNCf2*(k1k2*k1k4 + k2k3*k3k4) + (FFNCf2*k1k3 + FFNCf1*(k1k2 - k1k4 - k2k3 + k3k4) + FFNCga*(k1k2 + k1k4 + k2k3 + k3k4))*(M*M)) - 2*h*(FFNCgp*(k1k4*(k1s*k2k3 - k1k3*k2s) - (k1k2*k1s + k1k3*k2s)*k3k4 + k1k3*(k1k2 + k2k3)*k4s) + (2*FFNCga*(k1k2 + k1k4)*k1s + FFNCf1*k1s*(2*k1k2 - 2*k1k4 - k2k3 + k3k4) + FFNCf1*k1k3*(-k2s + k4s) + 2*FFNCga*k1k3*(k2s + k4s))*(M*M) + FFNCf2*(-(k1k4*k1s*k2k3) + k1k3*k1k4*k2s + k1k3*k2s*k3k4 + k1k3*k2k3*k4s + k1k2*(2*k1k4*k1s - k1s*k3k4 + k1k3*k4s) + 2*k1k3*k1s*(M*M)))*mHNL - (FFNCf2*(4*k1k2*k1k4 + k1k3*k2k4) + (3*FFNCf2*k1k3 + 2*FFNCf1*(k1k2 - k1k4) + 4*FFNCga*(k1k2 + k1k4))*(M*M))*(mHNL*mHNL) + h*(-2*FFNCgp*k1k4*k2s + 2*FFNCgp*k1k2*k4s + FFNCf2*(-(k1s*k2k4) + 2*k1k4*k2s + 2*k1k2*k4s + k1s*(M*M)))*(mHNL*mHNL*mHNL)))*Vhad*Vij)/(M*M*((mzprime*mzprime - t)*(mzprime*mzprime - t)))
        # mass mixing term SQR
        def Lmunu_Hmunu_MassMix_SQR():
            return -((Cprimehad*Cprimehad*(-8*((FFNCf1 - FFNCga)*(FFNCf1 - FFNCga)*k1k4*k2k3 + (FFNCf1 + FFNCga)*(FFNCf1 + FFNCga)*k1k2*k3k4)*(M*M) + 8*(FFNCf1 - FFNCga)*(FFNCf1 + FFNCga)*k1k3*(M*M*M*M) + 8*h*(M*M)*(FFNCga*(-2*FFNCf1*k1k4*k2s + FFNCgp*k1s*(k2k3 - k3k4) + 2*FFNCf1*k1k2*k4s + FFNCgp*k1k3*(-k2s + k4s)) + FFNCf1*FFNCf1*(k1k4*k2s + k1k2*k4s - k1s*(M*M)) + FFNCga*FFNCga*(k1k4*k2s + k1k2*k4s + k1s*(M*M)))*mHNL + 4*FFNCgp*(2*FFNCga*(k1k2 - k1k4)*(M*M) + FFNCgp*k1k3*(-k2k4 + M*M))*(mHNL*mHNL) + 4*(FFNCgp*FFNCgp)*h*k1s*(-k2k4 + M*M)*(mHNL*mHNL*mHNL) + FFNCf2*FFNCf2*(-4*k1k3*(k1k2*k1k4 + k2k3*k3k4 + k1k3*(M*M)) + 2*h*(-(k1k4*k1s*k2k3) + k1k3*k1k4*k2s + k1k3*k2s*k3k4 + k1k3*k2k3*k4s + k1k2*(2*k1k4*k1s - k1s*k3k4 + k1k3*k4s) + 2*k1k3*k1s*(M*M))*mHNL + (4*k1k2*k1k4 + k1k3*(k2k4 + 3*(M*M)))*(mHNL*mHNL) - h*(-(k1s*k2k4) + 2*k1k4*k2s + 2*k1k2*k4s + k1s*(M*M))*(mHNL*mHNL*mHNL)) + 4*FFNCf2*(FFNCf1*(M*M)*(2*k1k3*(-k1k2 + k1k4 + k2k3 - k3k4) + h*(k1s*(2*k1k2 - 2*k1k4 - k2k3 + k3k4) + k1k3*(-k2s + k4s))*mHNL + (k1k2 - k1k4)*(mHNL*mHNL)) + 2*FFNCga*(M*M)*(-(k1k3*(k1k2 + k1k4 + k2k3 + k3k4)) + h*((k1k2 + k1k4)*k1s + k1k3*(k2s + k4s))*mHNL + (k1k2 + k1k4)*(mHNL*mHNL)) + FFNCgp*h*mHNL*(k1k4*k1s*k2k3 - k1k3*k1k4*k2s - k1k2*k1s*k3k4 - k1k3*k2s*k3k4 + k1k2*k1k3*k4s + k1k3*k2k3*k4s + (k1k4*k2s - k1k2*k4s)*(mHNL*mHNL))))*Vij*Vji)/(M*M*((mzprime*mzprime - t)*(mzprime*mzprime - t))))
        # transition magnetic moment
        def Lmunu_Hmunu_TMM_SQR():
            return (4*(eQED*eQED)*(-4*FFf1*FFf2*(k1k2 - k1k4 - k2k3 + k3k4)*(M*M)*(2*(k1k3*k1k3) + k1k3*(2*h*k1s - 3*mHNL)*mHNL + h*k1s*(mHNL*mHNL*mHNL)) + 4*(FFf1*FFf1)*(M*M)*(2*k1k3*((k1k2 + k2k3)*(k1k4 + k3k4) + k1k3*(-k2k4 + M*M)) + 2*h*(-(k1s*k2k3*k3k4) + k1k2*(k1k4*k1s + k1k3*k4s) + k1k3*(k2s*(k1k4 + k3k4) + k2k3*k4s + k1s*(-k2k4 + M*M)))*mHNL + (-4*k1k2*k1k4 + k1k3*(k2k4 - 3*(M*M)))*(mHNL*mHNL) + h*(-2*(k1k4*k2s + k1k2*k4s) + k1s*(k2k4 + M*M))*(mHNL*mHNL*mHNL)) + FFf2*FFf2*(-4*(k1k3*k1k3*k1k3)*(k2k4 + M*M) + 4*(k1k3*k1k3)*(2*(k1k4*k2k3 + k1k2*k3k4) + h*(k2s*(k1k4 + k3k4) + (k1k2 + k2k3)*k4s - k1s*(k2k4 + M*M))*mHNL + (k2k4 + 2*(M*M))*(mHNL*mHNL)) + mHNL*mHNL*mHNL*(2*h*k1s*(k1k4*k2k3 + k1k2*(-2*k1k4 + k3k4)) + 4*k1k2*k1k4*mHNL + h*(-(k1s*k2k4) + 2*k1k4*k2s + 2*k1k2*k4s + k1s*(M*M))*(mHNL*mHNL)) + k1k3*mHNL*(4*h*k1s*(k1k4*k2k3 + k1k2*k3k4 - 2*k2k3*k3k4) - 2*h*(-2*k1s*k2k4 + 3*k1k4*k2s + k2s*k3k4 + 3*k1k2*k4s + k2k3*k4s)*(mHNL*mHNL) - mHNL*(4*k1k2*k1k4 + 8*k1k4*k2k3 + 8*k1k2*k3k4 - 4*k2k3*k3k4 + (k2k4 + 3*(M*M))*(mHNL*mHNL)))))*(Tij*Tij)*(Z*Z))/(M*M*(t*t))
        # scalar term SQR
        def Lmunu_Hmunu_Scalar_SQR():
            return (4*(FFscalar*FFscalar)*(k2k4 + M*M)*(k1k3 + h*k1s*mHNL)*(Shad*Shad)*Sij*Sji)/((MSCALAR*MSCALAR - t)*(MSCALAR*MSCALAR - t))
        # scalar + SM NC term
        def Lmunu_Hmunu_Scalar_NC_inter():
            return (-4*Chad*Cij*FFscalar*(FFNCf2*h*(k1k4*k1s*k2k3 - k1k3*k1k4*k2s - k1k2*k1s*k3k4 + k1k3*k2s*k3k4 + k1k2*k1k3*k4s - k1k3*k2k3*k4s) + FFNCf2*(k1k4*k2k3 - k1k2*k3k4)*mHNL + 2*FFNCf1*(M*M)*(h*k1s*(k2k3 + k3k4) - h*k1k3*(k2s + k4s) + (k1k2 + k1k4)*mHNL))*Shad*Sij)/(M*(MSCALAR*MSCALAR - t)*(-(MZBOSON*MZBOSON) + t))
        # scalar + kinetic mixing interference
        def Lmunu_Hmunu_Scalar_KinMix_inter():
            return (-4*FFscalar*(FFf2*h*(k1k4*k1s*k2k3 - k1k3*k1k4*k2s - k1k2*k1s*k3k4 + k1k3*k2s*k3k4 + k1k2*k1k3*k4s - k1k3*k2k3*k4s) + FFf2*(k1k4*k2k3 - k1k2*k3k4)*mHNL + 2*FFf1*(M*M)*(h*k1s*(k2k3 + k3k4) - h*k1k3*(k2s + k4s) + (k1k2 + k1k4)*mHNL))*Shad*Sij*Vhad*Vij)/(M*(MSCALAR*MSCALAR - t)*(-(mzprime*mzprime) + t))
        # scalar + mass mixing interference
        def Lmunu_Hmunu_Scalar_MassMix_inter():
            return (Cprimehad*Cij*FFscalar*mHNL*Shad*Sij*(4*FFNCf1*(M*M) + FFNCf2*t)*(s*Sqrt((M*M*M*M + (mHNL*mHNL - s)*(mHNL*mHNL - s) - 2*(M*M)*(mHNL*mHNL + s))/(s*s))*(2*(M*M) + mHNL*mHNL - 2*s - t) + h*(2*(M*M*M*M) + mHNL*mHNL*mHNL*mHNL + M*M*(-(mHNL*mHNL) - 4*s + t) - mHNL*mHNL*(3*s + t) + s*(2*s + 3*t))))/(M*s*Sqrt((M*M*M*M + (mHNL*mHNL - s)*(mHNL*mHNL - s) - 2*(M*M)*(mHNL*mHNL + s))/(s*s))*(MSCALAR*MSCALAR - t)*(-(MZBOSON*MZBOSON) + t))
    else:
